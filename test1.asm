...
int main(int argc, char *argv[]){
  ...
  1c:	50                   	push   %eax
  1d:	50                   	push   %eax
  1e:	68 b8 07 00 00       	push   $0x7b8
  23:	6a 01                	push   $0x1
  25:	e8 36 04 00 00       	call   460 <printf>
		exit();
  2a:	e8 e3 02 00 00       	call   312 <exit>
	}
	int n, off, len;
  ...
  36:	e8 17 03 00 00       	call   352 <open>
	off = atoi(argv[2]);
  3b:	5f                   	pop    %edi
  ...
  3f:	89 c6                	mov    %eax,%esi
	off = atoi(argv[2]);
  41:	e8 5a 02 00 00       	call   2a0 <atoi>
  46:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	len = atoi(argv[3]);
  49:	58                   	pop    %eax
  4a:	ff 73 0c             	pushl  0xc(%ebx)
  4d:	e8 4e 02 00 00       	call   2a0 <atoi>
  52:	89 c7                	mov    %eax,%edi
	lseek(n,off);
  54:	58                   	pop    %eax
  55:	5a                   	pop    %edx
  56:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  59:	52                   	push   %edx
  5a:	56                   	push   %esi
  5b:	e8 52 03 00 00       	call   3b2 <lseek>
	char string[len + 1];
  60:	8d 47 10             	lea    0x10(%edi),%eax
  63:	83 c4 10             	add    $0x10,%esp
  66:	83 e0 f0             	and    $0xfffffff0,%eax
  69:	29 c4                	sub    %eax,%esp
  6b:	89 e2                	mov    %esp,%edx
	read(n , string, len);
  6d:	51                   	push   %ecx
  6e:	57                   	push   %edi
  6f:	52                   	push   %edx
  70:	56                   	push   %esi
  71:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  74:	e8 b1 02 00 00       	call   32a <read>
	if(!strcmp(string, argv[4])) {
  79:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  7c:	5e                   	pop    %esi
  7d:	5f                   	pop    %edi
  7e:	ff 73 10             	pushl  0x10(%ebx)
  81:	52                   	push   %edx
  82:	e8 69 00 00 00       	call   f0 <strcmp>
  87:	83 c4 10             	add    $0x10,%esp
  8a:	85 c0                	test   %eax,%eax
  8c:	74 16                	je     a4 <main+0xa4>
		printf(1, "Matched \n");
	}
	else {
  ...
  8e:	50                   	push   %eax
  8f:	50                   	push   %eax
  90:	68 d7 07 00 00       	push   $0x7d7
  95:	6a 01                	push   $0x1
  97:	e8 c4 03 00 00       	call   460 <printf>
  ...
  a4:	52                   	push   %edx
  a5:	52                   	push   %edx
  a6:	68 cd 07 00 00       	push   $0x7cd
  ab:	6a 01                	push   $0x1
  ad:	e8 ae 03 00 00       	call   460 <printf>
  b2:	83 c4 10             	add    $0x10,%esp
  b5:	eb e8                	jmp    9f <main+0x9f>
  b7:	66 90                	xchg   %ax,%ax
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
  bd:	66 90                	xchg   %ax,%ax
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 3f7:	f7 f1                	div    %ecx
 3f9:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb e8 07 00 00       	mov    $0x7e8,%ebx
        while(*s != 0){
