...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 bb 78 10 80 	movl   $0x801078bb,(%esp)
...
80101ec8:	68 a2 76 10 80       	push   $0x801076a2
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 c2 56 10 80 	movl   $0x801056c2,0x14(%eax)
  p->context = (struct context*)sp;
...
801037ad:	68 78 75 10 80       	push   $0x80107578
...
80103d0d:	68 1d 75 10 80       	push   $0x8010751d
80103d12:	e8 79 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	68 10 75 10 80       	push   $0x80107510
...
80103e29:	68 2f 75 10 80       	push   $0x8010752f
80103e2e:	e8 5d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e33:	83 ec 0c             	sub    $0xc,%esp
80103e36:	68 29 75 10 80       	push   $0x80107529
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 32 2d 00 00       	call   80106c10 <freevm>
        release(&ptable.lock);
...
8010402b:	68 bb 78 10 80       	push   $0x801078bb
...
8010404e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104051:	ba 40 75 10 80       	mov    $0x80107540,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104056:	77 11                	ja     80104069 <procdump+0x59>
80104058:	8b 14 85 a0 75 10 80 	mov    -0x7fef8a60(,%eax,4),%edx
      state = "???";
8010405f:	b8 40 75 10 80       	mov    $0x80107540,%eax
...
80104071:	68 44 75 10 80       	push   $0x80107544
...
801040ad:	68 81 6f 10 80       	push   $0x80106f81
...
801040da:	68 b8 75 10 80       	push   $0x801075b8
...
801042f5:	68 c3 75 10 80       	push   $0x801075c3
801042fa:	e8 91 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
801042ff:	83 ec 0c             	sub    $0xc,%esp
80104302:	68 da 75 10 80       	push   $0x801075da
...
801043e7:	68 e1 75 10 80       	push   $0x801075e1
...
8010443c:	68 e9 75 10 80       	push   $0x801075e9
...
8010485c:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
...
80104880:	68 f1 75 10 80       	push   $0x801075f1
...
801049d4:	68 98 76 10 80       	push   $0x80107698
...
801049ec:	68 97 76 10 80       	push   $0x80107697
...
80104a05:	68 8b 76 10 80       	push   $0x8010768b
...
80104a1a:	68 9a 76 10 80       	push   $0x8010769a
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 7c 76 10 80       	push   $0x8010767c
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 98 76 10 80       	push   $0x80107698
...
80104e34:	68 97 76 10 80       	push   $0x80107697
...
80105484:	53                   	push   %ebx
	...
	char ch;
	argint(1, &n);
80105485:	8d 45 f0             	lea    -0x10(%ebp),%eax
int sys_lseek(void) {
80105488:	83 ec 18             	sub    $0x18,%esp
	argint(1, &n);
8010548b:	50                   	push   %eax
8010548c:	6a 01                	push   $0x1
8010548e:	e8 bd f2 ff ff       	call   80104750 <argint>
	struct file *f;
	argfd(0, 0, &f);
80105493:	8d 55 f4             	lea    -0xc(%ebp),%edx
80105496:	31 c0                	xor    %eax,%eax
80105498:	e8 a3 f5 ff ff       	call   80104a40 <argfd.constprop.0>
	for(i = 0; i < n; i++){
8010549d:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054a0:	83 c4 10             	add    $0x10,%esp
801054a3:	85 c0                	test   %eax,%eax
801054a5:	7e 41                	jle    801054e8 <sys_lseek+0x68>
801054a7:	31 db                	xor    %ebx,%ebx
801054a9:	8d 75 ef             	lea    -0x11(%ebp),%esi
801054ac:	eb 0a                	jmp    801054b8 <sys_lseek+0x38>
801054ae:	66 90                	xchg   %ax,%ax
801054b0:	83 c3 01             	add    $0x1,%ebx
801054b3:	39 5d f0             	cmp    %ebx,-0x10(%ebp)
801054b6:	7e 30                	jle    801054e8 <sys_lseek+0x68>
		if(!fileread(f, &ch, 1)) {
801054b8:	83 ec 04             	sub    $0x4,%esp
801054bb:	6a 01                	push   $0x1
801054bd:	56                   	push   %esi
801054be:	ff 75 f4             	pushl  -0xc(%ebp)
801054c1:	e8 9a ba ff ff       	call   80100f60 <fileread>
801054c6:	83 c4 10             	add    $0x10,%esp
801054c9:	85 c0                	test   %eax,%eax
801054cb:	75 e3                	jne    801054b0 <sys_lseek+0x30>
			argfd(0, 0, &f);
801054cd:	8d 55 f4             	lea    -0xc(%ebp),%edx
801054d0:	e8 6b f5 ff ff       	call   80104a40 <argfd.constprop.0>
			return -1;
		}
	}
	return 0;
}
801054d5:	8d 65 f8             	lea    -0x8(%ebp),%esp
			return -1;
...
801054ef:	5d                   	pop    %ebp
801054f0:	c3                   	ret    
801054f1:	66 90                	xchg   %ax,%ax
801054f3:	66 90                	xchg   %ax,%ax
801054f5:	66 90                	xchg   %ax,%ax
...
80105503:	5d                   	pop    %ebp
  return fork();
80105504:	e9 77 e4 ff ff       	jmp    80103980 <fork>
...
80105523:	5d                   	pop    %ebp
  return wait();
80105524:	e9 17 e9 ff ff       	jmp    80103e40 <wait>
...
8010553c:	e8 0f f2 ff ff       	call   80104750 <argint>
...
8010554e:	e8 3d ea ff ff       	call   80103f90 <kill>
...
80105573:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105576:	e8 65 e2 ff ff       	call   801037e0 <myproc>
...
80105597:	78 27                	js     801055c0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105599:	e8 42 e2 ff ff       	call   801037e0 <myproc>
  if(growproc(n) < 0)
...
801055a6:	e8 55 e3 ff ff       	call   80103900 <growproc>
...
801055dd:	e8 6e f1 ff ff       	call   80104750 <argint>
...
8010561d:	e8 5e e7 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
...
8010562f:	73 2f                	jae    80105660 <sys_sleep+0x90>
    if(myproc()->killed){
80105631:	e8 aa e1 ff ff       	call   801037e0 <myproc>
...
80105645:	e8 b6 ed ff ff       	call   80104400 <release>
      return -1;
...
80105668:	e8 93 ed ff ff       	call   80104400 <release>
  return 0;
...
8010569e:	e8 5d ed ff ff       	call   80104400 <release>
  return xticks;
}
...
801056e7:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
801056ee:	08 00 00 8e 
801056f2:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
801056f9:	80 
801056fa:	c1 ea 10             	shr    $0x10,%edx
801056fd:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105704:	80 
  for(i = 0; i < 256; i++)
...
80105714:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105717:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
8010571e:	00 00 ef 
  initlock(&tickslock, "time");
80105721:	68 dd 76 10 80       	push   $0x801076dd
80105726:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010572b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105731:	c1 e8 10             	shr    $0x10,%eax
80105734:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
8010573a:	e8 c1 ea ff ff       	call   80104200 <initlock>
}
...
8010589d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058a0:	e8 9b ef ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
...
80105947:	68 e8 76 10 80       	push   $0x801076e8
...
8010597a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105980:	e8 7b e2 ff ff       	call   80103c00 <exit>
80105985:	e9 0e ff ff ff       	jmp    80105898 <trap+0x118>
8010598a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105990:	e8 6b e2 ff ff       	call   80103c00 <exit>
80105995:	e9 aa fe ff ff       	jmp    80105844 <trap+0xc4>
8010599a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
801059a0:	83 ec 0c             	sub    $0xc,%esp
801059a3:	68 60 4c 11 80       	push   $0x80114c60
801059a8:	e8 93 e9 ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
801059ad:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
801059b4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
801059bb:	e8 70 e5 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
801059c0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801059c7:	e8 34 ea ff ff       	call   80104400 <release>
...
801059e5:	68 0c 77 10 80       	push   $0x8010770c
801059ea:	e8 71 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059ef:	83 c4 14             	add    $0x14,%esp
801059f2:	68 e2 76 10 80       	push   $0x801076e2
...
80105aec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105aef:	bb 04 78 10 80       	mov    $0x80107804,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010665a:	e8 f1 dd ff ff       	call   80104450 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066fd:	68 0c 78 10 80       	push   $0x8010780c
...
801069d9:	68 51 78 10 80       	push   $0x80107851
...
80106b3d:	68 89 78 10 80       	push   $0x80107889
...
80106cb0:	e8 9b d7 ff ff       	call   80104450 <memset>
...
80106da0:	e8 5b d7 ff ff       	call   80104500 <memmove>
...
80106e39:	68 f2 78 10 80       	push   $0x801078f2
80106e3e:	e8 4d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e43:	83 ec 0c             	sub    $0xc,%esp
80106e46:	68 d8 78 10 80       	push   $0x801078d8
...
80106ecf:	e8 2c d6 ff ff       	call   80104500 <memmove>
    len -= n;
    buf += n;
